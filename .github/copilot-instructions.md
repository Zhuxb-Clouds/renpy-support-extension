...
- **Files to review first:** [src/extension.ts](src/extension.ts), [bundled/tools/lsp_server.py](bundled/tools/lsp_server.py), [bundled/tools/ast_parser.py](bundled/tools/ast_parser.py), [language-configuration.json](language-configuration.json), and [package.json](package.json).
